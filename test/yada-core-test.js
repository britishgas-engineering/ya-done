...
describe('yadda-core : yadda function call returns configured yadda', () => {
  ...
  it('yadda step library, named framework phantomjs returns configured library', () => {
    expect(() => {
      yaddaCore(
        {
          given: spy('func'),
  ...
  it('yadda step library, object framework returns configured library', () => {
    expect(() =>
			yaddaCore(
  {
    given: spy('func'),
  ...
  it('yadda step library, array framework does not throw, returns default configuration', () => {
    expect(() => {
      yaddaCore(
        {
          given: spy('func'),
  ...
  it('yadda step library, function framework does not throw, returns default configuration', () => {
    expect(() => {
      yaddaCore(
        {
          given: spy('func'),
